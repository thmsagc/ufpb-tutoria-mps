...
public abstract class RelatorioAbstrato {
    ...
    protected List<String> ObterDados(){
        ...
        dados.add("Número de Usuários: "+ UsuarioControlImpl.getInstance().getUsuarios().size() +"\n");
        dados.add("Lista de Usuários:\n"+ UsuarioControlImpl.getInstance().getUsuarios());
        for(var usuario : UsuarioControlImpl.getInstance().getUsuarios()){
